...
import { getAllMultiLive, getAnalytics, getTopChatters, getWordCloud } from "../controller/analyticsController.js"
...
router.get("/idn/analytics/:slug/top-chatters", getTopChatters)
